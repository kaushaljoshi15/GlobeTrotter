...
const PRESET_PROMPTS = [
  {
    icon: '⛰️',
    title: 'Himalayan Mountain Escape',
    text: 'I have ₹30,000 and 5 days. Suggest mountains.',
  },
  {
    icon: '🏖️',
    title: 'Tropical Beach Terraces',
    text: '6 days in Tropical Archipelagos & Beach Coves on $1,400',
  },
  {
    icon: '⛩️',
    title: 'Kyoto Zen & Food Trail',
    text: '7 days Zen temples, tea ceremonies & food tour in Kyoto on $1,800',
  },
  {
    icon: '🏔️',
    title: 'Swiss Alps Glacier Passes',
...
function AIPlannerContent() {
  ...
  const initialPrompt = searchParams.get('prompt') || 'I have ₹30,000 and 5 days. Suggest mountains.';
  ...
  const REASONING_STEPS = [
    '🔍 Analyzing prompt: extracting budget, duration, currency & destination theme...',
    '🏔️ Synthesizing topographic geography, mountain passes & scenic viewpoints...',
  ...
  const handleGenerate = async (queryText?: string) => {
    ...
    // Simulate multi-step reasoning animation
    ...
    <div className="space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/10 border border-white/15 text-[#e4c29e] text-[11px] font-sans font-medium mb-3">
          ...
          <span>Atelier Artificial Intelligence &bull; Flagship Engine</span>
        </div>
        ...
        <p className="font-serif text-stone-300 text-sm sm:text-base leading-relaxed">
          Type your natural travel idea, budget in any currency &amp; duration. Our AI crafts an instant, itemized expedition timeline with live spend balancing.
        </p>
      </div>

      {/* Prompt Search Command Box */}
      <div className="max-w-4xl mx-auto bg-[#14151a]/95 backdrop-blur-2xl border border-white/15 rounded-[32px] p-5 sm:p-7 shadow-2xl space-y-4 font-sans">
        ...
        >
          ...
          <input
            ...
            placeholder='e.g. "I have ₹30,000 and 5 days. Suggest mountains." or "2 weeks in Europe on $2,500"'
        ...
        <div className="flex flex-wrap items-center gap-2 pt-2">
          ...
          {PRESET_PROMPTS.map((preset, idx) => (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0c0d10] hover:bg-white/10 text-stone-300 hover:text-white border border-white/10 text-[11px] font-medium transition-all cursor-pointer"
            >
      ...
      {loading && (
        <div className="max-w-3xl mx-auto p-8 rounded-[32px] bg-[#14151a]/80 backdrop-blur-xl border border-white/10 text-center space-y-4 font-sans animate-pulse">
          ...
          <h3 className="font-serif text-2xl font-medium text-white">Composing Your Bespoke Itinerary</h3>
      ...
      {itinerary && !loading && (
        <div className="space-y-10 font-sans">
          ...
          {/* 4 Financial Budget Allocation Pills */}
