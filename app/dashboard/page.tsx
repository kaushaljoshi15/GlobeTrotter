      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-slate-400 text-sm sm:text-base max-w-xl">
                Ready to plan your next journey? You currently have <span className="text-blue-400 font-semibold">{totalTrips} planned itineraries</span> across the globe.
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-10">
          ...
          <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-5 backdrop-blur-md hover:border-slate-700 transition-colors">
            ...
            <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400">Active</div>
            <div className="text-[11px] text-slate-500 mt-1">Ready for departure</div>
          </div>
        </div>
