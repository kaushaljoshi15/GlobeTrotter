...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-orange-500 selection:text-slate-950 overflow-hidden relative font-sans flex flex-col items-center">
      {/* Background Ambient Glow Lights */}
      <div className="absolute top-[-15%] left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-gradient-to-tr from-amber-600/20 via-orange-600/15 to-rose-600/10 rounded-full blur-[140px] -z-10 pointer-events-none" />
      <div className="absolute top-[40%] right-[-10%] w-[600px] h-[600px] bg-rose-500/10 rounded-full blur-[130px] -z-10 pointer-events-none" />
